				   ...
				   <div class="member-col member-left">
					   ...
					   <div class="member-col-inner">
						   <div class="member-form-wrap">
							   ...
							   <p style="color: red; display: none;" class="error">Tài khoản không tồn tại</p>
							   <p style="color: red; display: none;" class="disable">Tài khoản chưa kích hoạt</p>
							   <p style="color: red; display: none;" class="empty">Tài khoản hoặc mật khẩu trống</p>
								<input type="text" id="loginEmail" class="form-control" placeholder="Nhập Email">
								
							   
                               <div class="row">
                               		<div class="col-xs-6">
                                    	<!--<label><input type="checkbox">Giữ tôi đăng nhập</label>-->
                                    </div><!--/.col-xs-6-->
                                    
                                    <div class="col-xs-6">
                                    	<input type="button" value="Đăng Nhập" id="loginSubmit" class="btn btn-blue btn-block"/>
                                    </div><!--/.col-xs-6-->
                               </div><!--/.row-->
							   ...
							   <input type="button" name="regSubmit" id="regSubmit" value="ĐĂNG KÝ" class="btn btn-blue btn-block"/>
								<span id="state"></span>
